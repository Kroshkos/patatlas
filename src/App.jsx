...
const App = () => {
  ...
  const featuredTopics = [
    { id: 1, title: 'Воспаление', category: 'pathology', image: '🦠', desc: 'Молекулярные механизмы воспалительного ответа' },
    { id: 2, title: 'Гипоксия', category: 'pathology', image: '💨', desc: 'Типы гипоксии и адаптационные механизмы' },
    { id: 3, title: 'Опухолевый рост', category: 'molecular', image: '🧫', desc: 'Канцерогенез и молекулярные основы' },
    { id: 4, title: 'Сердечная недостаточность', category: 'systems', image: '💔', desc: 'Механизмы декомпенсации' },
    { id: 5, title: 'Патология печени', category: 'organs', image: '🧪', desc: 'Цирроз и печеночная недостаточность' },
    { id: 6, title: 'Атеросклероз', category: 'systems', image: '🩸', desc: 'Нарушения липидного обмена' }
  ];
          ...
          {filteredTopics.map(topic => (
            <div key={topic.id} className="topic-card">
              ...
              <div className="topic-content">
                ...
                <button className="topic-btn">Изучить →</button>
              </div>
            </div>
          ))}
        </div>
